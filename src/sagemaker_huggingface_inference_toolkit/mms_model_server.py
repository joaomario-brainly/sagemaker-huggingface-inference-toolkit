...
EBS_VOLUME_PATH  = "/home/ec2-user/SageMaker/"

DEFAULT_HF_HUB_MODEL_EXPORT_DIRECTORY = os.path.join(EBS_VOLUME_PATH, ".sagemaker/mms/models")

logger.info(f'DEFAULT_HF_HUB_MODEL_EXPORT_DIRECTORY={DEFAULT_HF_HUB_MODEL_EXPORT_DIRECTORY}')

# DEFAULT_MODEL_STORE = "/"
DEFAULT_MODEL_STORE = EBS_VOLUME_PATH
